...
int main(void) {
 ...
 assert(announce(&receiver,&phone,-60)==RX_OK);
 ...
 assert(announce(&receiver,&phone,-68)==RX_OK); /* Existing-peer grace. */
 ...
 puts("PASS: normal filter rejects captured weak signal; disabling it reproduces wrong master selection");
}
